...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Pa(){return new Hr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fa(){return new Hr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ia(),fragmentShader:`
...
`,xd=class extends md{constructor(e){super(e,{className:`psv-menu-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:jc.menu}),this.viewer.addEventListener(zu.type,this),this.viewer.addEventListener(du.type,this),super.hide()}destroy(){this.viewer.removeEventListener(zu.type,this),this.viewer.removeEventListener(du.type,this),super.destroy()}handleEvent(e){e instanceof zu?this.toggleActive(e.panelId===kc.MENU):e instanceof du&&this.toggleActive(!1)}onClick(){this.state.active?this.__hideMenu():this.__showMenu()}hide(e){super.hide(e),this.__hideMenu()}show(e){super.show(e),this.state.active&&this.__showMenu()}__showMenu(){this.viewer.panel.show({id:kc.MENU,content:bd(this.viewer.navbar.collapsed,this.viewer.config.lang.menu),noMargin:!0,clickHandler:e=>{let t=e?Gc(e,`.psv-panel-menu-item`):void 0,n=t?t.dataset[yd]:void 0;n&&(this.viewer.navbar.getButton(n).onClick(),this.__hideMenu())}})}__hideMenu(){this.viewer.panel.hide(kc.MENU)}};xd.id=`menu`;function Sd(e){let t=0;switch(e){case 0:t=90;break;case 1:t=-90;break;case 3:t=180;break;default:t=0;break}return jc.arrow.replace(`rotate(0`,`rotate(${t}`)}var Cd=class extends md{constructor(e,t){super(e,{className:`psv-move-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:Sd(t)}),this.direction=t,this.handler=new Vl,this.container.addEventListener(`mousedown`,this),this.container.addEventListener(`keydown`,this),this.container.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this)}destroy(){this.__onMouseUp(),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown();break;case`mouseup`:this.__onMouseUp();break;case`touchend`:this.__onMouseUp();break;case`keydown`:e.key===Ac.Enter&&this.__onMouseDown();break;case`keyup`:e.key===Ac.Enter&&this.__onMouseUp();break}}onClick(){}isSupported(){return pl(id.isTouchEnabled)}__onMouseDown(){if(!this.state.enabled)return;let e={};switch(this.direction){case 0:e.pitch=!1;break;case 1:e.pitch=!0;break;case 3:e.yaw=!1;break;default:e.yaw=!0;break}this.viewer.stopAll(),this.viewer.dynamics.position.roll(e),this.handler.down()}__onMouseUp(){this.state.enabled&&this.handler.up(()=>{this.viewer.dynamics.position.stop(),this.viewer.resetIdleTimer()})}};Cd.groupId=`move`;var wd=class extends Cd{constructor(e){super(e,1)}};wd.id=`moveDown`;var Td=class extends Cd{constructor(e){super(e,2)}};Td.id=`moveLeft`;var Ed=class extends Cd{constructor(e){super(e,3)}};Ed.id=`moveRight`;var Dd=class extends Cd{constructor(e){super(e,0)}};Dd.id=`moveUp`;var Od=class extends md{constructor(e,t,n){super(e,{className:`psv-zoom-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:t}),this.direction=n,this.handler=new Vl,this.container.addEventListener(`mousedown`,this),this.container.addEventListener(`keydown`,this),this.container.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this)}destroy(){this.__onMouseUp(),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown();break;case`mouseup`:this.__onMouseUp();break;case`touchend`:this.__onMouseUp();break;case`keydown`:e.key===Ac.Enter&&this.__onMouseDown();break;case`keyup`:e.key===Ac.Enter&&this.__onMouseUp();break}}onClick(){}isSupported(){return pl(id.isTouchEnabled)}__onMouseDown(){this.state.enabled&&(this.viewer.dynamics.zoom.roll(this.direction===1),this.handler.down())}__onMouseUp(){this.state.enabled&&this.handler.up(()=>this.viewer.dynamics.zoom.stop())}};Od.groupId=`zoom`;var kd=class extends Od{constructor(e){super(e,jc.zoomIn,0)}};kd.id=`zoomIn`;var Ad=class extends Od{constructor(e){super(e,jc.zoomOut,1)}};Ad.id=`zoomOut`;var jd=class extends md{constructor(e){super(e,{className:`psv-zoom-range`,hoverScale:!1,collapsable:!1,tabbable:!1}),this.zoomRange=document.createElement(`div`),this.zoomRange.className=`psv-zoom-range-line`,this.container.appendChild(this.zoomRange),this.zoomValue=document.createElement(`div`),this.zoomValue.className=`psv-zoom-range-handle`,this.zoomRange.appendChild(this.zoomValue),this.slider=new Ul(this.container,`HORIZONTAL`,e=>this.__onSliderUpdate(e)),this.mediaMinWidth=parseInt(Yc(this.container,`max-width`),10),this.viewer.addEventListener(qu.type,this),this.viewer.state.ready?this.__moveZoomValue(this.viewer.getZoomLevel()):this.viewer.addEventListener(ju.type,this)}destroy(){this.slider.destroy(),this.viewer.removeEventListener(qu.type,this),this.viewer.removeEventListener(ju.type,this),super.destroy()}handleEvent(e){e instanceof qu?this.__moveZoomValue(e.zoomLevel):e instanceof ju&&this.__moveZoomValue(this.viewer.getZoomLevel())}onClick(){}isSupported(){return pl(id.isTouchEnabled)}autoSize(){this.state.supported&&(this.viewer.state.size.width<=this.mediaMinWidth&&this.state.visible?this.hide(!1):this.viewer.state.size.width>this.mediaMinWidth&&!this.state.visible&&this.show(!1))}__moveZoomValue(e){this.zoomValue.style.left=e/100*this.zoomRange.offsetWidth-this.zoomValue.offsetWidth/2+`px`}__onSliderUpdate(e){e.mousedown&&this.viewer.zoom(e.value*100)}};jd.id=`zoomRange`,jd.groupId=`zoom`;var Md=class extends Gl{constructor(e){super(),this.viewer=e}init(){}destroy(){}},Nd=class extends Md{constructor(e,t){super(e),this.config=this.constructor.configParser(t)}setOption(e,t){this.setOptions({[e]:t})}setOptions(e){let t={...this.config,...e},n=this.constructor,r=n.configParser,i=n.readonlyOptions,a=n.id;for(let[n,o]of Object.entries(e)){if(!(n in r.defaults)){gl(`${a}: Unknown option "${n}"`);continue}if(i.includes(n)){gl(`${a}: Option "${n}" cannot be updated`);continue}n in r.parsers&&(o=r.parsers[n](o,{rawConfig:t,defValue:r.defaults[n]})),this.config[n]=o}}};Nd.readonlyOptions=[];function Pd(e){if(e){for(let[,t]of[[`_`,e],...Object.entries(e)])if(t.prototype instanceof Md)return Fl(t.id,t.VERSION,`5.14.1`),t}return null}var Fd={panorama:null,container:null,adapter:[ud,null],plugins:[],caption:null,description:null,downloadUrl:null,downloadName:null,loadingImg:null,loadingTxt:``,size:null,fisheye:0,minFov:30,maxFov:90,defaultZoomLvl:50,defaultYaw:0,defaultPitch:0,sphereCorrection:null,moveSpeed:1,zoomSpeed:1,moveInertia:.8,mousewheel:!0,mousemove:!0,mousewheelCtrlKey:!1,touchmoveTwoFingers:!1,panoData:null,requestHeaders:null,canvasBackground:`#000`,defaultTransition:{speed:1500,rotation:!0,effect:`fade`},rendererParameters:{alpha:!0,antialias:!0},withCredentials:()=>!1,navbar:[`zoom`,`move`,`download`,`description`,`caption`,`fullscreen`],lang:{zoom:`Zoom`,zoomOut:`Zoom out`,zoomIn:`Zoom in`,moveUp:`Move up`,moveDown:`Move down`,moveLeft:`Move left`,moveRight:`Move right`,description:`Description`,download:`Download`,fullscreen:`Fullscreen`,loading:`Loading...`,menu:`Menu`,close:`Close`,twoFingers:`Use two fingers to navigate`,ctrlZoom:`Use ctrl + scroll to zoom the image`,loadError:`The panorama cannot be loaded`,webglError:`Your browser does not seem to support WebGL`},keyboard:`fullscreen`,keyboardActions:{[Ac.ArrowUp]:`ROTATE_UP`,[Ac.ArrowDown]:`ROTATE_DOWN`,[Ac.ArrowRight]:`ROTATE_RIGHT`,[Ac.ArrowLeft]:`ROTATE_LEFT`,[Ac.PageUp]:`ZOOM_IN`,[Ac.PageDown]:`ZOOM_OUT`,[Ac.Plus]:`ZOOM_IN`,[Ac.Minus]:`ZOOM_OUT`}},Id={panorama:`Use setPanorama method to change the panorama`,panoData:`Use setPanorama method to change the panorama`,container:`Cannot change viewer container`,adapter:`Cannot change adapter`,plugins:`Cannot change plugins`},Ld={container:e=>{if(!e)throw new Q(`No value given for container.`);return e},adapter:(e,{defValue:t})=>{if(e=e?Array.isArray(e)?[nd(e[0]),e[1]]:[nd(e),null]:t,!e[0])throw new Q(`An undefined value was given for adapter.`);if(!e[0].id)throw new Q(`Adapter has no id.`);return e},defaultYaw:e=>kl(e),defaultPitch:e=>kl(e,!0),defaultZoomLvl:e=>W.clamp(e,0,100),minFov:(e,{rawConfig:t})=>(t.maxFov<e&&(gl(`maxFov cannot be lower than minFov`),e=t.maxFov),W.clamp(e,1,179)),maxFov:(e,{rawConfig:t})=>(e<t.minFov&&(e=t.minFov),W.clamp(e,1,179)),moveInertia:(e,{defValue:t})=>e===!0?t:e===!1?0:e,lang:e=>({...Fd.lang,...e}),fisheye:e=>e===!0?1:e===!1?0:e,requestHeaders:e=>e&&typeof e==`object`?()=>e:typeof e==`function`?e:null,withCredentials:e=>typeof e==`boolean`?()=>e:typeof e==`function`?e:()=>!1,defaultTransition:(e,{defValue:t})=>e===null||e.speed===0?null:{...t,...e},rendererParameters:(e,{defValue:t})=>({...e,...t}),plugins:e=>e.map((e,t)=>{if(e=Array.isArray(e)?[Pd(e[0]),e[1]]:[Pd(e),null],!e[0])throw new Q(`An undefined value was given for plugin ${t}.`);if(!e[0].id)throw new Q(`Plugin ${t} has no id.`);return e}),navbar:e=>e===!1?null:e===!0?ol(Fd.navbar):typeof e==`string`?e.split(/[ ,]/):e},Rd=Nl(Fd,Ld),zd=class extends md{constructor(e){super(e,{className:`psv-caption`,hoverScale:!1,collapsable:!1,tabbable:!0}),this.contentWidth=0,this.state.width=0,this.contentElt=document.createElement(`div`),this.contentElt.className=`psv-caption-content`,this.container.appendChild(this.contentElt),this.setCaption(this.viewer.config.caption)}hide(){this.contentElt.style.display=`none`,this.state.visible=!1}show(){this.contentElt.style.display=``,this.state.visible=!0}onClick(){}setCaption(e){this.show(),this.contentElt.innerHTML=e??``,this.contentElt.innerHTML?this.contentWidth=this.contentElt.offsetWidth:this.contentWidth=0,this.autoSize()}autoSize(){this.toggle(this.container.offsetWidth>=this.contentWidth),this.__refreshButton()}__refreshButton(){this.viewer.navbar.getButton(gd.id,!1)?.autoSize(!0)}};zd.id=`caption`;var Bd={},Vd={};function Hd(e,t){if(!e.id)throw new Q(`Button id is required`);if(Bd[e.id]=e,e.groupId&&(Vd[e.groupId]=Vd[e.groupId]||[]).push(e),t){let n=Fd.navbar;switch(t){case`start`:n.unshift(e.id);break;case`end`:n.push(e.id);break;default:{let[r,i]=t.split(`:`),a=n.indexOf(r);if(!r||!i||a===-1)throw new Q(`Invalid defaultPosition ${t}`);n.splice(a+ +(i===`right`),0,e.id)}}}}[Ad,jd,kd,gd,zd,_d,vd,Td,Ed,Dd,wd].forEach(e=>Hd(e));var Ud=class extends fd{constructor(e){super(e,{className:`psv-navbar ${Dc}`}),this.collapsed=[],this.state.visible=!1}show(){this.viewer.container.classList.add(`psv--has-navbar`),this.container.classList.add(`psv-navbar--open`),this.state.visible=!0}hide(){this.viewer.container.classList.remove(`psv--has-navbar`),this.container.classList.remove(`psv-navbar--open`),this.state.visible=!1}setButtons(e){this.children.slice().forEach(e=>e.destroy()),this.children.length=0,e.indexOf(zd.id)!==-1&&e.indexOf(gd.id)===-1&&e.splice(e.indexOf(zd.id),0,gd.id),e.forEach(e=>{typeof e==`object`?new hd(this,e):Bd[e]?new Bd[e](this):Vd[e]?Vd[e].forEach(e=>{new e(this)}):gl(`Unknown button ${e}`)}),new xd(this),this.children.forEach(e=>{e instanceof md&&e.checkSupported()}),this.autoSize()}setCaption(e){this.children.some(t=>t instanceof zd?(t.setCaption(e),!0):!1)}getButton(e,t=!0){let n=this.children.find(t=>t instanceof md&&t.id===e);return!n&&t&&gl(`button "${e}" not found in the navbar`),n}focusButton(e){this.isVisible()&&(this.getButton(e,!1)?.container||this.container.firstElementChild)?.focus()}autoSize(){this.children.forEach(e=>{e instanceof md&&e.autoSize()});let e=this.container.offsetWidth,t=0,n=[];this.children.forEach(e=>{e.isVisible()&&e instanceof md&&(t+=e.width,e.collapsable&&n.push(e))}),t!==0&&(e<t&&n.length>0?(n.forEach(e=>e.collapse()),this.collapsed=n,this.getButton(xd.id).show(!1)):e>=t&&this.collapsed.length>0&&(this.collapsed.forEach(e=>e.uncollapse()),this.collapsed=[],this.getButton(xd.id).hide(!1)),this.getButton(zd.id,!1)?.autoSize())}};Ai.enabled=!1;var Wd={enabled:!0,maxItems:10,ttl:600,items:{},purgeInterval:null,init(){Ai.enabled&&=(gl(`ThreeJS cache should be disabled`),!1),!this.purgeInterval&&this.enabled&&(this.purgeInterval=setInterval(()=>this.purge(),60*1e3))},add(e,t,n){this.enabled&&t&&(this.items[t]=this.items[t]??{files:{},lastAccess:null},this.items[t].files[e]=n,this.items[t].lastAccess=Date.now())},get(e,t){if(this.enabled&&t&&this.items[t])return this.items[t].lastAccess=Date.now(),this.items[t].files[e]},remove(e,t){this.enabled&&t&&this.items[t]&&(delete this.items[t].files[e],Object.keys(this.items[t].files).length===0&&delete this.items[t])},purge(){Object.entries(this.items).sort(([,e],[,t])=>t.lastAccess-e.lastAccess).forEach(([e,{lastAccess:t}],n)=>{n>0&&(Date.now()-t>=this.ttl*1e3||n>=this.maxItems)&&delete this.items[e]})}},Gd=class extends fd{constructor(e){super(e,{className:`psv-loader-container`}),this.loader=document.createElement(`div`),this.loader.className=`psv-loader`,this.container.appendChild(this.loader),this.size=this.loader.offsetWidth,this.canvas=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`),this.canvas.setAttribute(`class`,`psv-loader-canvas`),this.canvas.setAttribute(`viewBox`,`0 0 ${this.size} ${this.size}`),this.loader.appendChild(this.canvas),this.textColor=Yc(this.loader,`color`),this.color=Yc(this.canvas,`color`),this.border=parseInt(Yc(this.loader,`--psv-loader-border`),10),this.thickness=parseInt(Yc(this.loader,`--psv-loader-tickness`),10);let t=this.size/2;this.canvas.innerHTML=`
            <circle cx="${t}" cy="${t}" r="${t}" fill="${this.color}"/>
            <path d="" fill="none" stroke="${this.textColor}" stroke-width="${this.thickness}" stroke-linecap="round"/>
        `,this.viewer.addEventListener(tu.type,this),this.__updateContent(),this.hide()}destroy(){this.viewer.removeEventListener(tu.type,this),super.destroy()}handleEvent(e){e instanceof tu&&e.containsOptions(`loadingImg`,`loadingTxt`,`lang`)&&this.__updateContent()}setProgress(e){this.container.classList.remove(`psv-loader--undefined`);let t=W.clamp(e,0,99.999)/100*Math.PI*2,n=this.size/2,r=n,i=this.thickness/2+this.border,a=(this.size-this.thickness)/2-this.border,o=Math.sin(t)*a+n,s=-Math.cos(t)*a+n,c=e>50?`1`:`0`;this.canvas.querySelector(`path`).setAttributeNS(null,`d`,`M ${r} ${i} A ${a} ${a} 0 ${c} 1 ${o} ${s}`)}showUndefined(){this.show(),this.setProgress(25),this.container.classList.add(`psv-loader--undefined`)}__updateContent(){let e=this.loader.querySelector(`.psv-loader-image, .psv-loader-text`);e&&this.loader.removeChild(e);let t;if(this.viewer.config.loadingImg?(t=document.createElement(`img`),t.className=`psv-loader-image`,t.src=this.viewer.config.loadingImg):this.viewer.config.loadingTxt!==null&&(t=document.createElement(`div`),t.className=`psv-loader-text`,t.innerHTML=this.viewer.config.loadingTxt||this.viewer.config.lang.loading),t){let e=Math.round(Math.sqrt(2*(this.size/2-this.thickness/2-this.border)**2));t.style.maxWidth=e+`px`,t.style.maxHeight=e+`px`,this.loader.appendChild(t)}}},Kd=class extends fd{constructor(e){super(e,{className:`psv-notification`}),this.state={visible:!1,contentId:null,timeout:null},this.content=document.createElement(`div`),this.content.className=`psv-notification-content`,this.container.appendChild(this.content),this.content.addEventListener(`click`,()=>this.hide())}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new Q(`Notification cannot be toggled`)}show(e){this.state.timeout&&(clearTimeout(this.state.timeout),this.state.timeout=null),typeof e==`string`&&(e={content:e}),this.state.contentId=e.id||null,this.content.innerHTML=e.content,this.container.classList.add(`psv-notification--visible`),this.state.visible=!0,this.viewer.dispatchEvent(new Fu(this.state.contentId)),e.timeout&&(this.state.timeout=setTimeout(()=>this.hide(this.state.contentId),e.timeout))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;this.container.classList.remove(`psv-notification--visible`),this.state.visible=!1,this.state.contentId=null,this.viewer.dispatchEvent(new su(e))}}},qd=class extends fd{constructor(e){super(e,{className:`psv-overlay ${Dc}`}),this.state={visible:!1,contentId:null,dismissible:!0},this.image=document.createElement(`div`),this.image.className=`psv-overlay-image`,this.container.appendChild(this.image),this.title=document.createElement(`div`),this.title.className=`psv-overlay-title`,this.container.appendChild(this.title),this.text=document.createElement(`div`),this.text.className=`psv-overlay-text`,this.container.appendChild(this.text),this.container.addEventListener(`click`,this),this.viewer.addEventListener(hu.type,this),super.hide()}destroy(){this.viewer.removeEventListener(hu.type,this),super.destroy()}handleEvent(e){e.type===`click`?this.isVisible()&&this.state.dismissible&&(this.hide(),e.stopPropagation()):e instanceof hu&&this.isVisible()&&this.state.dismissible&&e.matches(Ac.Escape)&&(this.hide(),e.preventDefault())}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new Q(`Overlay cannot be toggled`)}show(e){typeof e==`string`&&(e={title:e}),this.state.contentId=e.id||null,this.state.dismissible=e.dismissible!==!1,this.image.innerHTML=e.image||``,this.title.innerHTML=e.title||``,this.text.innerHTML=e.text||``,super.show(),this.viewer.dispatchEvent(new Lu(this.state.contentId))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;super.hide(),this.state.contentId=null,this.viewer.dispatchEvent(new lu(e))}}},Jd=200,Yd=`psv-panel-content--no-interaction`,Xd=class extends fd{constructor(e){super(e,{className:`psv-panel ${Dc}`}),this.state={visible:!1,contentId:null,mouseX:0,mouseY:0,mousedown:!1,clickHandler:null,keyHandler:null,width:{}};let t=document.createElement(`div`);t.className=`psv-panel-resizer`,this.container.appendChild(t);let n=document.createElement(`div`);n.className=`psv-panel-close-button`,n.innerHTML=jc.close,n.title=e.config.lang.close,this.container.appendChild(n),this.content=document.createElement(`div`),this.content.className=`psv-panel-content`,this.container.appendChild(this.content),n.addEventListener(`click`,()=>this.hide()),t.addEventListener(`mousedown`,this),t.addEventListener(`touchstart`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this),this.viewer.container.addEventListener(`mousemove`,this),this.viewer.container.addEventListener(`touchmove`,this),this.viewer.addEventListener(hu.type,this)}destroy(){this.viewer.removeEventListener(hu.type,this),this.viewer.container.removeEventListener(`mousemove`,this),this.viewer.container.removeEventListener(`touchmove`,this),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown(e);break;case`touchstart`:this.__onTouchStart(e);break;case`mousemove`:this.__onMouseMove(e);break;case`touchmove`:this.__onTouchMove(e);break;case`mouseup`:this.__onMouseUp(e);break;case`touchend`:this.__onTouchEnd(e);break;case hu.type:this.__onKeyPress(e);break}}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new Q(`Panel cannot be toggled`)}show(e){typeof e==`string`&&(e={content:e});let t=this.isVisible(e.id);this.state.contentId=e.id||null,this.state.visible=!0,this.state.clickHandler&&(this.content.removeEventListener(`click`,this.state.clickHandler),this.content.removeEventListener(`keydown`,this.state.keyHandler),this.state.clickHandler=null,this.state.keyHandler=null),e.id&&this.state.width[e.id]?this.container.style.width=this.state.width[e.id]:e.width?this.container.style.width=e.width:this.container.style.width=null,this.content.innerHTML=e.content,this.content.scrollTop=0,this.container.classList.add(`psv-panel--open`),Vc(this.content,`psv-panel-content--no-margin`,e.noMargin===!0),e.clickHandler&&(this.state.clickHandler=t=>{e.clickHandler(Kc(t))},this.state.keyHandler=t=>{t.key===Ac.Enter&&e.clickHandler(Kc(t))},this.content.addEventListener(`click`,this.state.clickHandler),this.content.addEventListener(`keydown`,this.state.keyHandler),t||setTimeout(()=>{this.content.querySelector(`a,button,[tabindex]`)?.focus()},300)),this.viewer.dispatchEvent(new zu(this.state.contentId))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;this.state.visible=!1,this.state.contentId=null,this.content.innerHTML=null,this.container.classList.remove(`psv-panel--open`),this.state.clickHandler&&(this.content.removeEventListener(`click`,this.state.clickHandler),this.content.removeEventListener(`keydown`,this.state.keyHandler),this.state.clickHandler=null,this.state.keyHandler=null),this.viewer.dispatchEvent(new du(e))}}__onMouseDown(e){e.stopPropagation(),this.__startResize(e.clientX,e.clientY)}__onTouchStart(e){if(e.stopPropagation(),e.touches.length===1){let t=e.touches[0];this.__startResize(t.clientX,t.clientY)}}__onMouseUp(e){this.state.mousedown&&(e.stopPropagation(),this.state.mousedown=!1,this.content.classList.remove(Yd))}__onTouchEnd(e){this.state.mousedown&&(e.stopPropagation(),e.touches.length===0&&(this.state.mousedown=!1,this.content.classList.remove(Yd)))}__onMouseMove(e){this.state.mousedown&&(e.stopPropagation(),this.__resize(e.clientX,e.clientY))}__onTouchMove(e){if(this.state.mousedown){let t=e.touches[0];this.__resize(t.clientX,t.clientY)}}__onKeyPress(e){this.isVisible()&&e.matches(Ac.Escape)&&(this.hide(),e.preventDefault())}__startResize(e,t){this.state.mouseX=e,this.state.mouseY=t,this.state.mousedown=!0,this.content.classList.add(Yd)}__resize(e,t){let n=e,r=t,i=Math.max(Jd,this.container.offsetWidth-(n-this.state.mouseX))+`px`;this.state.contentId&&(this.state.width[this.state.contentId]=i),this.container.style.width=i,this.state.mouseX=n,this.state.mouseY=r}},Zd=class extends fd{constructor(e,t){super(e,{className:`psv-tooltip`}),this.state={visible:!0,arrow:0,border:0,state:0,width:0,height:0,pos:``,config:null,data:null,hideTimeout:null},this.content=document.createElement(`div`),this.content.className=`psv-tooltip-content`,this.container.appendChild(this.content),this.arrow=document.createElement(`div`),this.arrow.className=`psv-tooltip-arrow`,this.container.appendChild(this.arrow),this.container.addEventListener(`transitionend`,this),this.container.addEventListener(`touchdown`,e=>e.stopPropagation()),this.container.addEventListener(`mousedown`,e=>e.stopPropagation()),this.container.style.top=`-1000px`,this.container.style.left=`-1000px`,this.show(t)}handleEvent(e){e.type===`transitionend`&&this.__onTransitionEnd(e)}destroy(){clearTimeout(this.state.hideTimeout),delete this.state.data,super.destroy()}toggle(){throw new Q(`Tooltip cannot be toggled`)}show(e){if(this.state.state!==0)throw new Q(`Initialized tooltip cannot be re-initialized`);e.className&&Hc(this.container,e.className),e.style&&Object.assign(this.container.style,e.style),this.state.state=3,this.update(e.content,e),this.state.data=e.data,this.state.state=1,this.viewer.dispatchEvent(new Vu(this,this.state.data)),this.__waitImages()}update(e,t){this.content.innerHTML=e;let n=this.container.getBoundingClientRect();this.state.width=n.right-n.left,this.state.height=n.bottom-n.top,this.state.arrow=parseInt(Yc(this.arrow,`border-top-width`),10),this.state.border=parseInt(Yc(this.container,`border-top-left-radius`),10),this.move(t??this.state.config),this.__waitImages()}move(e){if(this.state.state!==1&&this.state.state!==3)throw new Q(`Uninitialized tooltip cannot be moved`);e.box=e.box??this.state.config?.box??{width:0,height:0},this.state.config=e;let t=this.container,n=this.arrow,r={posClass:Tl(e.position,{allowCenter:!1,cssOrder:!1})||[`top`,`center`],width:this.state.width,height:this.state.height,top:0,left:0,arrowTop:0,arrowLeft:0};this.__computeTooltipPosition(r,e);let i=null,a=null;if(r.top<0?i=`bottom`:r.top+r.height>this.viewer.state.size.height&&(i=`top`),r.left<0?a=`right`:r.left+r.width>this.viewer.state.size.width&&(a=`left`),a||i){let t=El(r.posClass);i&&(r.posClass[+!t]=i),a&&(r.posClass[+!!t]=a),this.__computeTooltipPosition(r,e)}t.style.top=r.top+`px`,t.style.left=r.left+`px`,n.style.top=r.arrowTop+`px`,n.style.left=r.arrowLeft+`px`;let o=r.posClass.join(`-`);o!==this.state.pos&&(t.classList.remove(`psv-tooltip--${this.state.pos}`),this.state.pos=o,t.classList.add(`psv-tooltip--${this.state.pos}`))}hide(){this.container.classList.remove(`psv-tooltip--visible`),this.state.state=2,this.viewer.dispatchEvent(new pu(this.state.data));let e=parseFloat(Yc(this.container,`transition-duration`));this.state.hideTimeout=setTimeout(()=>{this.destroy()},e*2)}__onTransitionEnd(e){if(e.propertyName===`transform`)switch(this.state.state){case 1:this.container.classList.add(`psv-tooltip--visible`),this.state.state=3;break;case 2:this.state.state=0,this.destroy();break;default:}}__computeTooltipPosition(e,t){let n=this.state.arrow,r=t.top,i=e.height,a=t.left,o=e.width,s=n+this.state.border,c=t.box.width/2+n*2,l=t.box.height/2+n*2;switch(e.posClass.join(`-`)){case`top-left`:e.top=r-l-i,e.left=a+s-o,e.arrowTop=i,e.arrowLeft=o-s-n;break;case`top-center`:e.top=r-l-i,e.left=a-o/2,e.arrowTop=i,e.arrowLeft=o/2-n;break;case`top-right`:e.top=r-l-i,e.left=a-s,e.arrowTop=i,e.arrowLeft=n;break;case`bottom-left`:e.top=r+l,e.left=a+s-o,e.arrowTop=-n*2,e.arrowLeft=o-s-n;break;case`bottom-center`:e.top=r+l,e.left=a-o/2,e.arrowTop=-n*2,e.arrowLeft=o/2-n;break;case`bottom-right`:e.top=r+l,e.left=a-s,e.arrowTop=-n*2,e.arrowLeft=n;break;case`left-top`:e.top=r+s-i,e.left=a-c-o,e.arrowTop=i-s-n,e.arrowLeft=o;break;case`center-left`:e.top=r-i/2,e.left=a-c-o,e.arrowTop=i/2-n,e.arrowLeft=o;break;case`left-bottom`:e.top=r-s,e.left=a-c-o,e.arrowTop=n,e.arrowLeft=o;break;case`right-top`:e.top=r+s-i,e.left=a+c,e.arrowTop=i-s-n,e.arrowLeft=-n*2;break;case`center-right`:e.top=r-i/2,e.left=a+c,e.arrowTop=i/2-n,e.arrowLeft=-n*2;break;case`right-bottom`:e.top=r-s,e.left=a+c,e.arrowTop=n,e.arrowLeft=-n*2;break}}__waitImages(){let e=this.content.querySelectorAll(`img`);if(e.length>0){let t=[];e.forEach(e=>{e.complete||t.push(new Promise(t=>{e.onload=t,e.onerror=t}))}),t.length&&Promise.all(t).then(()=>{if(this.state.state===1||this.state.state===3){let e=this.container.getBoundingClientRect();this.state.width=e.right-e.left,this.state.height=e.bottom-e.top,this.move(this.state.config)}})}}},Qd=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="15 15 70 70"><path fill="currentColor" d="M50,16.2c-18.6,0-33.8,15.1-33.8,33.8S31.4,83.7,50,83.7S83.8,68.6,83.8,50S68.6,16.2,50,16.2z M50,80.2c-16.7,0-30.2-13.6-30.2-30.2S33.3,19.7,50,19.7S80.3,33.3,80.3,50S66.7,80.2,50,80.2z"/><rect fill="currentColor" x="48" y="31.7" width="4" height="28"/><rect fill="currentColor" x="48" y="63.2" width="4" height="5"/><!--Created by Shastry from the Noun Project--></svg>
`,$d=class{constructor(e){this.viewer=e,this.config=e.config,this.state=e.state}destroy(){}},ef=new K,tf=new yn(0,0,0,`ZXY`),nf=class extends $d{constructor(e){super(e)}fovToZoomLevel(e){let t=Math.round((e-this.config.minFov)/(this.config.maxFov-this.config.minFov)*100);return W.clamp(t-2*(t-50),0,100)}zoomLevelToFov(e){return this.config.maxFov+e/100*(this.config.minFov-this.config.maxFov)}vFovToHFov(e){return W.radToDeg(2*Math.atan(Math.tan(W.degToRad(e)/2)*this.state.aspect))}hFovToVFov(e){return W.radToDeg(2*Math.atan(Math.tan(W.degToRad(e)/2)/this.state.aspect))}getAnimationProperties(e,t,n){let r=!cl(t),i=!cl(n),a={},o=null;if(r){let n=this.viewer.getPosition(),r=Lc(n.yaw,t.yaw);a.yaw={start:n.yaw,end:n.yaw+r},a.pitch={start:n.pitch,end:t.pitch},o=Ol(e,Rc(n,t))}if(i){let t=this.viewer.getZoomLevel(),r=Math.abs(n-t);a.zoom={start:t,end:n},o===null&&(o=Ol(e,Math.PI/4*r/100))}return o=o===null?typeof e==`number`?e:yc:Math.max(yc,o),{duration:o,properties:a}}getTransitionOptions(e){let t,n=this.config.defaultTransition??Fd.defaultTransition;return t=e.transition===!1||e.transition===null?null:e.transition===!0?{...n}:typeof e.transition==`object`?{...n,...e.transition}:this.config.defaultTransition,t}textureCoordsToSphericalCoords(e){if(!this.state.textureData?.panoData)throw new Q(`Current adapter does not support texture coordinates or no texture has been loaded`);let t=this.viewer.adapter.textureCoordsToSphericalCoords(e,this.state.textureData.panoData);return!tf.equals(this.viewer.renderer.panoramaPose)||!tf.equals(this.viewer.renderer.sphereCorrection)?(this.sphericalCoordsToVector3(t,ef),ef.applyEuler(this.viewer.renderer.panoramaPose),ef.applyEuler(this.viewer.renderer.sphereCorrection),this.vector3ToSphericalCoords(ef)):t}sphericalCoordsToTextureCoords(e){if(!this.state.textureData?.panoData)throw new Q(`Current adapter does not support texture coordinates or no texture has been loaded`);return(!tf.equals(this.viewer.renderer.panoramaPose)||!tf.equals(this.viewer.renderer.sphereCorrection))&&(this.sphericalCoordsToVector3(e,ef),Ml(ef,this.viewer.renderer.sphereCorrection),Ml(ef,this.viewer.renderer.panoramaPose),e=this.vector3ToSphericalCoords(ef)),this.viewer.adapter.sphericalCoordsToTextureCoords(e,this.state.textureData.panoData)}sphericalCoordsToVector3(e,t,n=Tc){return t||=new K,t.x=n*-Math.cos(e.pitch)*Math.sin(e.yaw),t.y=n*Math.sin(e.pitch),t.z=n*Math.cos(e.pitch)*Math.cos(e.yaw),t}vector3ToSphericalCoords(e){let t=Math.acos(e.y/Math.sqrt(e.x*e.x+e.y*e.y+e.z*e.z)),n=Math.atan2(e.x,e.z);return{yaw:n<0?-n:Math.PI*2-n,pitch:Math.PI/2-t}}viewerCoordsToVector3(e){let t=this.viewer.renderer.getIntersections(e).filter(e=>e.object.userData[Ec]);return t.length?t[0].point:null}viewerCoordsToSphericalCoords(e){let t=this.viewerCoordsToVector3(e);return t?this.vector3ToSphericalCoords(t):null}vector3ToViewerCoords(e){let t=e.clone();return t.project(this.viewer.renderer.camera),{x:Math.round((t.x+1)/2*this.state.size.width),y:Math.round((1-t.y)/2*this.state.size.height)}}sphericalCoordsToViewerCoords(e){return this.sphericalCoordsToVector3(e,ef),this.vector3ToViewerCoords(ef)}isPointVisible(e){let t,n;if(e instanceof K)t=e,n=this.vector3ToViewerCoords(e);else if(_l(e))t=this.sphericalCoordsToVector3(e,ef),n=this.vector3ToViewerCoords(t);else return!1;return t.dot(this.viewer.state.direction)>0&&n.x>=0&&n.x<=this.viewer.state.size.width&&n.y>=0&&n.y<=this.viewer.state.size.height}cleanPosition(e){if(`yaw`in e||`pitch`in e){if(!(`yaw`in e)||!(`pitch`in e))throw new Q(`Position is missing 'yaw' or 'pitch'`);return{yaw:kl(e.yaw),pitch:kl(e.pitch,!0)}}else return this.textureCoordsToSphericalCoords(e)}cleanSphereCorrection(e){return{pan:kl(e?.pan||0),tilt:kl(e?.tilt||0,!0),roll:kl(e?.roll||0,!0,!1)}}cleanPanoramaPose(e){return{pan:W.degToRad(e?.poseHeading||0),tilt:W.degToRad(e?.posePitch||0),roll:W.degToRad(e?.poseRoll||0)}}cleanPanoramaOptions(e,t){return t?.isEquirectangular?(cl(e.zoom)&&!cl(t.initialFov)&&(e={...e,zoom:this.fovToZoomLevel(this.hFovToVFov(t.initialFov))}),cl(e.position)&&!cl(t.initialHeading)&&!cl(t.initialPitch)&&(e={...e,position:{yaw:kl(t.initialHeading),pitch:kl(t.initialPitch,!0)}}),e):e}},rf=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path fill="currentColor" d="M33.38 33.2a1.96 1.96 0 0 0 1.5-3.23 10.61 10.61 0 0 1 7.18-17.51c.7-.06 1.31-.49 1.61-1.12a13.02 13.02 0 0 1 11.74-7.43c7.14 0 12.96 5.8 12.96 12.9 0 3.07-1.1 6.05-3.1 8.38-.7.82-.61 2.05.21 2.76.83.7 2.07.6 2.78-.22a16.77 16.77 0 0 0 4.04-10.91C72.3 7.54 64.72 0 55.4 0a16.98 16.98 0 0 0-14.79 8.7 14.6 14.6 0 0 0-12.23 14.36c0 3.46 1.25 6.82 3.5 9.45.4.45.94.69 1.5.69m45.74 43.55a22.13 22.13 0 0 1-5.23 12.4c-4 4.55-9.53 6.86-16.42 6.86-12.6 0-20.1-10.8-20.17-10.91a1.82 1.82 0 0 0-.08-.1c-5.3-6.83-14.55-23.82-17.27-28.87-.05-.1 0-.21.02-.23a6.3 6.3 0 0 1 8.24 1.85l9.38 12.59a1.97 1.97 0 0 0 3.54-1.17V25.34a4 4 0 0 1 1.19-2.87 3.32 3.32 0 0 1 2.4-.95c1.88.05 3.4 1.82 3.4 3.94v24.32a1.96 1.96 0 0 0 3.93 0v-33.1a3.5 3.5 0 0 1 7 0v35.39a1.96 1.96 0 0 0 3.93 0v-.44c.05-2.05 1.6-3.7 3.49-3.7 1.93 0 3.5 1.7 3.5 3.82v5.63c0 .24.04.48.13.71l.1.26a1.97 1.97 0 0 0 3.76-.37c.33-1.78 1.77-3.07 3.43-3.07 1.9 0 3.45 1.67 3.5 3.74l-1.77 18.1zM77.39 51c-1.25 0-2.45.32-3.5.9v-.15c0-4.27-3.33-7.74-7.42-7.74-1.26 0-2.45.33-3.5.9V16.69a7.42 7.42 0 0 0-14.85 0v1.86a7 7 0 0 0-3.28-.94 7.21 7.21 0 0 0-5.26 2.07 7.92 7.92 0 0 0-2.38 5.67v37.9l-5.83-7.82a10.2 10.2 0 0 0-13.35-2.92 4.1 4.1 0 0 0-1.53 5.48C20 64.52 28.74 80.45 34.07 87.34c.72 1.04 9.02 12.59 23.4 12.59 7.96 0 14.66-2.84 19.38-8.2a26.06 26.06 0 0 0 6.18-14.6l1.78-18.2v-.2c0-4.26-3.32-7.73-7.42-7.73z"/><!--Created by AomAm from the Noun Project--></svg>
...
`,of=class e{constructor(){this.$=e.IDLE}is(...e){return e.some(e=>this.$&e)}set(e){this.$=e}add(e){this.$|=e}remove(e){this.$&=~e}};of.IDLE=0,of.CLICK=1,of.MOVING=2;var sf=of,cf=class extends $d{constructor(e){super(e),this.data={startMouseX:0,startMouseY:0,mouseX:0,mouseY:0,pinchDist:0,moveDelta:{yaw:0,pitch:0,zoom:0},accumulatorFactor:0,ctrlKeyDown:!1,dblclickData:null,dblclickTimeout:null,longtouchTimeout:null,twofingersTimeout:null,ctrlZoomTimeout:null},this.step=new sf,this.keyHandler=new Vl,this.resizeObserver=new ResizeObserver(rl(()=>this.viewer.autoSize(),50)),this.moveThreshold=bc*id.pixelRatio}init(){window.addEventListener(`keydown`,this,{passive:!1}),window.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mousedown`,this),window.addEventListener(`mousemove`,this,{passive:!1}),window.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchstart`,this,{passive:!1}),window.addEventListener(`touchmove`,this,{passive:!1}),window.addEventListener(`touchend`,this,{passive:!1}),this.viewer.container.addEventListener(`wheel`,this,{passive:!1}),document.addEventListener(`fullscreenchange`,this),this.resizeObserver.observe(this.viewer.container),this.viewer.addEventListener(Yl.type,this),this.viewer.addEventListener(Gu.type,this)}destroy(){window.removeEventListener(`keydown`,this),window.removeEventListener(`keyup`,this),this.viewer.container.removeEventListener(`mousedown`,this),window.removeEventListener(`mousemove`,this),window.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchstart`,this),window.removeEventListener(`touchmove`,this),window.removeEventListener(`touchend`,this),this.viewer.container.removeEventListener(`wheel`,this),document.removeEventListener(`fullscreenchange`,this),this.resizeObserver.disconnect(),this.viewer.removeEventListener(Yl.type,this),this.viewer.removeEventListener(Gu.type,this),clearTimeout(this.data.dblclickTimeout),clearTimeout(this.data.longtouchTimeout),clearTimeout(this.data.twofingersTimeout),clearTimeout(this.data.ctrlZoomTimeout),super.destroy()}handleEvent(e){switch(e.type){case`keydown`:this.__onKeyDown(e);break;case`keyup`:this.__onKeyUp();break;case`mousemove`:this.__onMouseMove(e);break;case`mouseup`:this.__onMouseUp(e);break;case`touchmove`:this.__onTouchMove(e);break;case`touchend`:this.__onTouchEnd(e);break;case`fullscreenchange`:this.__onFullscreenChange();break;case Yl.type:this.__applyMoveDelta();break;case Gu.type:this.__clearMoveDelta();break}if(!qc(e,`.`+Dc))switch(e.type){case`mousedown`:this.__onMouseDown(e);break;case`touchstart`:this.__onTouchStart(e);break;case`wheel`:this.__onMouseWheel(e);break}}__onKeyDown(e){if(this.config.mousewheelCtrlKey&&(this.data.ctrlKeyDown=e.key===Ac.Control,this.data.ctrlKeyDown&&(clearTimeout(this.data.ctrlZoomTimeout),this.viewer.overlay.hide(kc.CTRL_ZOOM))),this.viewer.dispatchEvent(new hu(e.key,e))&&!(!this.state.keyboardEnabled||!this.config.keyboardActions||this.keyHandler.pending)){for(let[t,n]of Object.entries(this.config.keyboardActions))if(tl(e,t)){if(typeof n==`function`)n(this.viewer,e);else{switch(n!==`ZOOM_IN`&&n!==`ZOOM_OUT`&&this.viewer.stopAll(),n){case`ROTATE_UP`:this.viewer.dynamics.position.roll({pitch:!1});break;case`ROTATE_DOWN`:this.viewer.dynamics.position.roll({pitch:!0});break;case`ROTATE_RIGHT`:this.viewer.dynamics.position.roll({yaw:!1});break;case`ROTATE_LEFT`:this.viewer.dynamics.position.roll({yaw:!0});break;case`ZOOM_IN`:this.viewer.dynamics.zoom.roll(!1);break;case`ZOOM_OUT`:this.viewer.dynamics.zoom.roll(!0);break}this.keyHandler.down(n)}e.preventDefault();return}}}__onKeyUp(){this.data.ctrlKeyDown=!1,this.state.keyboardEnabled&&this.keyHandler.up(e=>{e===`ZOOM_IN`||e===`ZOOM_OUT`?this.viewer.dynamics.zoom.stop():(this.viewer.dynamics.position.stop(),this.viewer.resetIdleTimer())})}__onMouseDown(e){this.step.add(sf.CLICK),this.data.startMouseX=e.clientX,this.data.startMouseY=e.clientY,this.config.mousemove&&e.preventDefault()}__onMouseUp(e){this.step.is(sf.CLICK,sf.MOVING)&&this.__stopMove(e.clientX,e.clientY,e,e.button===2)}__onMouseMove(e){this.config.mousemove&&this.step.is(sf.CLICK,sf.MOVING)&&(e.preventDefault(),this.__doMove(e.clientX,e.clientY)),this.__handleObjectsEvents(e)}__onTouchStart(e){e.touches.length===1?(this.step.add(sf.CLICK),this.data.startMouseX=e.touches[0].clientX,this.data.startMouseY=e.touches[0].clientY,this.data.longtouchTimeout||(this.data.longtouchTimeout=setTimeout(()=>{let t=e.touches[0];this.__stopMove(t.clientX,t.clientY,e,!0),this.data.longtouchTimeout=null},Sc))):e.touches.length===2&&(this.step.set(sf.IDLE),this.__cancelLongTouch(),this.config.mousemove&&(this.__cancelTwoFingersOverlay(),this.__startMoveZoom(e),e.preventDefault()))}__onTouchEnd(e){if(this.__cancelLongTouch(),this.step.is(sf.CLICK,sf.MOVING)){if(e.preventDefault(),this.__cancelTwoFingersOverlay(),e.touches.length===1)this.__stopMove(this.data.mouseX,this.data.mouseY);else if(e.touches.length===0){let t=e.changedTouches[0];this.__stopMove(t.clientX,t.clientY,e)}}}__onTouchMove(e){if(this.__cancelLongTouch(),this.config.mousemove)if(e.touches.length===1){if(this.config.touchmoveTwoFingers)this.step.is(sf.CLICK)&&!this.data.twofingersTimeout&&(this.data.twofingersTimeout=setTimeout(()=>{this.viewer.overlay.show({id:kc.TWO_FINGERS,image:rf,title:this.config.lang.twoFingers})},Cc));else if(this.step.is(sf.CLICK,sf.MOVING)){e.preventDefault();let t=e.touches[0];this.__doMove(t.clientX,t.clientY)}}else this.__doMoveZoom(e),this.__cancelTwoFingersOverlay()}__cancelLongTouch(){this.data.longtouchTimeout&&(clearTimeout(this.data.longtouchTimeout),this.data.longtouchTimeout=null)}__cancelTwoFingersOverlay(){this.config.touchmoveTwoFingers&&(this.data.twofingersTimeout&&(clearTimeout(this.data.twofingersTimeout),this.data.twofingersTimeout=null),this.viewer.overlay.hide(kc.TWO_FINGERS))}__onMouseWheel(e){if(!this.config.mousewheel||!e.deltaY)return;if(this.config.mousewheelCtrlKey&&!this.data.ctrlKeyDown){this.viewer.overlay.show({id:kc.CTRL_ZOOM,image:af,title:this.config.lang.ctrlZoom}),clearTimeout(this.data.ctrlZoomTimeout),this.data.ctrlZoomTimeout=setTimeout(()=>this.viewer.overlay.hide(kc.CTRL_ZOOM),wc);return}e.preventDefault(),e.stopPropagation();let t=e.deltaY/Math.abs(e.deltaY)*5*this.config.zoomSpeed;t!==0&&this.viewer.dynamics.zoom.step(-t,5)}__onFullscreenChange(){let e=this.viewer.isFullscreenEnabled();this.config.keyboard===`fullscreen`&&(e?this.viewer.startKeyboardControl():this.viewer.stopKeyboardControl()),this.viewer.dispatchEvent(new au(e))}__resetMove(){this.step.set(sf.IDLE),this.data.mouseX=0,this.data.mouseY=0,this.data.startMouseX=0,this.data.startMouseY=0}__startMoveZoom(e){this.viewer.stopAll(),this.__resetMove();let t=Xc(e);this.step.set(sf.MOVING),this.data.accumulatorFactor=this.config.moveInertia,{distance:this.data.pinchDist,center:{x:this.data.mouseX,y:this.data.mouseY}}=t}__stopMove(e,t,n,r=!1){this.step.is(sf.CLICK)&&!this.__moveThresholdReached(e,t)&&this.__doClick(e,t,n,r),this.config.moveInertia&&(this.data.accumulatorFactor=this.config.moveInertia**.5),this.__resetMove(),this.viewer.resetIdleTimer()}__doClick(e,t,n,r=!1){let i=this.viewer.container.getBoundingClientRect(),a=e-i.left,o=t-i.top,s=this.viewer.renderer.getIntersections({x:a,y:o}),c=s.find(e=>e.object.userData[Ec]);if(c){let i=this.viewer.dataHelper.vector3ToSphericalCoords(c.point),l={rightclick:r,originalEvent:n,target:Kc(n),clientX:e,clientY:t,viewerX:a,viewerY:o,yaw:i.yaw,pitch:i.pitch,objects:s.map(e=>e.object).filter(e=>!e.userData[Ec])};try{let e=this.viewer.dataHelper.sphericalCoordsToTextureCoords(l);Object.assign(l,e)}catch{}this.data.dblclickTimeout?(Math.abs(this.data.dblclickData.clientX-l.clientX)<this.moveThreshold&&Math.abs(this.data.dblclickData.clientY-l.clientY)<this.moveThreshold&&this.viewer.dispatchEvent(new ru(this.data.dblclickData)),clearTimeout(this.data.dblclickTimeout),this.data.dblclickTimeout=null,this.data.dblclickData=null):(this.viewer.dispatchEvent(new $l(l)),this.data.dblclickData=ol(l),this.data.dblclickTimeout=setTimeout(()=>{this.data.dblclickTimeout=null,this.data.dblclickData=null},xc))}}__handleObjectsEvents(e){if(!sl(this.state.objectsObservers)&&e.composedPath().includes(this.viewer.container)){let t=Jc(this.viewer.container),n={x:e.clientX-t.x,y:e.clientY-t.y},r=this.viewer.renderer.getIntersections(n),i=(t,r,i)=>{this.viewer.dispatchEvent(new i(e,t,n,r))};for(let[e,t]of Object.entries(this.state.objectsObservers)){let n=r.find(t=>t.object.userData[e]);n?(t&&n.object!==t&&(i(t,e,Qu),this.state.objectsObservers[e]=null),t?i(n.object,e,ed):(this.state.objectsObservers[e]=n.object,i(n.object,e,Xu))):t&&(i(t,e,Qu),this.state.objectsObservers[e]=null)}}}__doMove(e,t){if(this.step.is(sf.CLICK)&&this.__moveThresholdReached(e,t))this.viewer.stopAll(),this.__resetMove(),this.step.set(sf.MOVING),this.data.mouseX=e,this.data.mouseY=t,this.data.accumulatorFactor=this.config.moveInertia;else if(this.step.is(sf.MOVING)){let n=(e-this.data.mouseX)*Math.cos(this.state.roll)-(t-this.data.mouseY)*Math.sin(this.state.roll),r=(t-this.data.mouseY)*Math.cos(this.state.roll)+(e-this.data.mouseX)*Math.sin(this.state.roll),i={yaw:this.config.moveSpeed*(n/this.state.size.width)*W.degToRad(this.state.hFov),pitch:this.config.moveSpeed*(r/this.state.size.height)*W.degToRad(this.state.vFov)};this.data.moveDelta.yaw+=i.yaw,this.data.moveDelta.pitch+=i.pitch,this.data.mouseX=e,this.data.mouseY=t}}__moveThresholdReached(e,t){return Math.abs(e-this.data.startMouseX)>=this.moveThreshold||Math.abs(t-this.data.startMouseY)>=this.moveThreshold}__doMoveZoom(e){if(this.step.is(sf.MOVING)){e.preventDefault();let t=Xc(e);this.__doMove(t.center.x,t.center.y),this.data.moveDelta.zoom+=this.config.zoomSpeed*((t.distance-this.data.pinchDist)/id.pixelRatio),this.data.pinchDist=t.distance}}__applyMoveDelta(){let e=.001;if(Math.abs(this.data.moveDelta.yaw)>0||Math.abs(this.data.moveDelta.pitch)>0){let t=this.viewer.getPosition();this.viewer.rotate({yaw:t.yaw-this.data.moveDelta.yaw*(1-this.config.moveInertia),pitch:t.pitch+this.data.moveDelta.pitch*(1-this.config.moveInertia)}),this.data.moveDelta.yaw*=this.data.accumulatorFactor,this.data.moveDelta.pitch*=this.data.accumulatorFactor,Math.abs(this.data.moveDelta.yaw)<=e&&(this.data.moveDelta.yaw=0),Math.abs(this.data.moveDelta.pitch)<=e&&(this.data.moveDelta.pitch=0)}if(Math.abs(this.data.moveDelta.zoom)>0){let t=this.viewer.getZoomLevel();this.viewer.zoom(t+this.data.moveDelta.zoom*(1-this.config.moveInertia)),this.data.moveDelta.zoom*=this.config.moveInertia,Math.abs(this.data.moveDelta.zoom)<=e&&(this.data.moveDelta.zoom=0)}}__clearMoveDelta(){this.data.moveDelta.yaw=0,this.data.moveDelta.pitch=0,this.data.moveDelta.zoom=0}};J.enabled=!1;var lf=new G,uf=new ln,df=new Ft,ff=class extends $d{constructor(e){super(e),this.frustumNeedsUpdate=!0,this.renderer=new sc(this.config.rendererParameters),this.renderer.setPixelRatio(id.pixelRatio),this.renderer.outputColorSpace=Ae,this.renderer.toneMapping=1,this.renderer.domElement.className=`psv-canvas`,this.renderer.domElement.style.background=this.config.canvasBackground,this.scene=new ni,this.camera=new qr(50,16/9,.1,2*Tc),this.camera.matrixAutoUpdate=!1;let t=new jr(new pi(Tc).scale(-1,1,1),new ir({opacity:0,transparent:!0,depthTest:!1,depthWrite:!1}));t.userData={[Ec]:!0},this.scene.add(t),this.raycaster=new $i,this.frustum=new ui,this.container=document.createElement(`div`),this.container.className=`psv-canvas-container`,this.container.appendChild(this.renderer.domElement),this.viewer.container.appendChild(this.container),this.container.addEventListener(`contextmenu`,e=>e.preventDefault()),this.viewer.addEventListener(Uu.type,this),this.viewer.addEventListener(qu.type,this),this.viewer.addEventListener(Du.type,this),this.viewer.addEventListener(ku.type,this),this.viewer.addEventListener(tu.type,this),this.hide()}get panoramaPose(){return this.mesh.rotation}get sphereCorrection(){return this.meshContainer.rotation}init(){this.show(),this.renderer.setAnimationLoop(e=>this.__renderLoop(e))}destroy(){this.renderer.setAnimationLoop(null),this.cleanScene(this.scene),this.renderer.dispose(),this.viewer.container.removeChild(this.container),this.viewer.removeEventListener(Uu.type,this),this.viewer.removeEventListener(qu.type,this),this.viewer.removeEventListener(Du.type,this),this.viewer.removeEventListener(ku.type,this),this.viewer.removeEventListener(tu.type,this),super.destroy()}handleEvent(e){switch(e.type){case Uu.type:this.__onSizeUpdated();break;case qu.type:this.__onZoomUpdated();break;case Du.type:this.__onPositionUpdated();break;case ku.type:this.__onPositionUpdated();break;case tu.type:e.containsOptions(`fisheye`)&&this.__onPositionUpdated(),e.containsOptions(`canvasBackground`)&&(this.renderer.domElement.style.background=this.config.canvasBackground);break}}hide(){this.container.style.opacity=`0`}show(){this.container.style.opacity=`1`}setCustomRenderer(e){e?this.customRenderer=e(this.renderer):this.customRenderer=null,this.viewer.needsUpdate()}__onSizeUpdated(){this.renderer.setSize(this.state.size.width,this.state.size.height),this.camera.aspect=this.state.aspect,this.camera.updateProjectionMatrix(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__onZoomUpdated(){this.camera.fov=this.state.vFov,this.camera.updateProjectionMatrix(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__onPositionUpdated(){this.camera.position.set(0,0,0),this.camera.lookAt(this.state.direction),this.config.fisheye&&this.camera.position.copy(this.state.direction).multiplyScalar(this.config.fisheye/2).negate(),this.camera.rotateZ(-this.state.roll),this.camera.updateMatrix(),this.camera.updateMatrixWorld(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__renderLoop(e){let t=this.timestamp?e-this.timestamp:0;this.timestamp=e,this.viewer.dispatchEvent(new Yl(e,t)),this.viewer.dynamics.update(t),(this.state.needsUpdate||this.state.continuousUpdateCount>0)&&(this.state.needsUpdate=!1,(this.customRenderer||this.renderer).render(this.scene,this.camera),this.viewer.dispatchEvent(new Nu))}setTexture(e){this.meshContainer||(this.meshContainer=new $r,this.scene.add(this.meshContainer)),this.state.textureData&&this.viewer.adapter.disposeTexture(this.state.textureData),this.mesh&&(this.meshContainer.remove(this.mesh),this.viewer.adapter.disposeMesh(this.mesh)),this.mesh=this.viewer.adapter.createMesh(e.panoData),this.viewer.adapter.setTexture(this.mesh,e,!1),this.meshContainer.add(this.mesh),this.state.textureData=e,this.viewer.needsUpdate()}setPanoramaPose(e,t=this.mesh){let n=this.viewer.dataHelper.cleanPanoramaPose(e);t.rotation.set(-n.tilt,n.pan,n.roll,`YXZ`)}setSphereCorrection(e,t=this.meshContainer){let n=this.viewer.dataHelper.cleanSphereCorrection(e);t.rotation.set(n.tilt,n.pan,n.roll,`YXZ`)}transition(e,t,n){let r=n.effect===`fade`||n.rotation,i=!cl(t.position),a=!cl(t.zoom),o=new ql(i?this.viewer.dataHelper.cleanPosition(t.position):void 0,t.zoom);this.viewer.dispatchEvent(o);let s=new $r,c=this.viewer.adapter.createMesh(e.panoData);if(this.viewer.adapter.setTexture(c,e,!0),this.viewer.adapter.setTextureOpacity(c,0),this.setPanoramaPose(e.panoData,c),this.setSphereCorrection(t.sphereCorrection,s),i&&!n.rotation){let e=this.viewer.getPosition(),t=new K(0,1,0);s.rotateOnWorldAxis(t,o.position.yaw-e.yaw);let n=new K(0,1,0).cross(this.camera.getWorldDirection(new K)).normalize();s.rotateOnWorldAxis(n,o.position.pitch-e.pitch)}s.add(c),this.scene.add(s),this.renderer.setRenderTarget(new Mt),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null);let{duration:l,properties:u}=this.viewer.dataHelper.getAnimationProperties(n.speed,n.rotation?o.position:null,r?o.zoomLevel:null),d=new Rl({properties:{...u,opacity:{start:0,end:1}},duration:l,easing:`inOutCubic`,onTick:e=>{switch(n.effect){case`fade`:this.viewer.adapter.setTextureOpacity(c,e.opacity);break;case`black`:case`white`:e.opacity<.5?this.renderer.toneMappingExposure=n.effect===`black`?W.mapLinear(e.opacity,0,.5,1,0):W.mapLinear(e.opacity,0,.5,1,5):(this.renderer.toneMappingExposure=n.effect===`black`?W.mapLinear(e.opacity,.5,1,0,1):W.mapLinear(e.opacity,.5,1,5,1),this.mesh.visible=!1,this.viewer.adapter.setTextureOpacity(c,1),a&&!r&&this.viewer.dynamics.zoom.setValue(o.zoomLevel));break}i&&n.rotation&&this.viewer.dynamics.position.setValue({yaw:e.yaw,pitch:e.pitch}),a&&r&&this.viewer.dynamics.zoom.setValue(e.zoom),this.viewer.needsUpdate()}});return d.then(r=>{s.remove(c),this.scene.remove(s),r?(this.viewer.adapter.disposeTexture(this.state.textureData),this.meshContainer.remove(this.mesh),this.viewer.adapter.disposeMesh(this.mesh),this.mesh=c,this.meshContainer.add(c),this.state.textureData=e,this.setPanoramaPose(e.panoData),this.setSphereCorrection(t.sphereCorrection),i&&!n.rotation&&this.viewer.rotate(t.position)):(this.viewer.adapter.disposeTexture(e),this.viewer.adapter.disposeMesh(c))}),d}getIntersections(e){lf.x=2*e.x/this.state.size.width-1,lf.y=-2*e.y/this.state.size.height+1,this.raycaster.setFromCamera(lf,this.camera);let t=this.raycaster.intersectObjects(this.scene.children,!0).filter(e=>e.object.visible).filter(e=>e.object.isMesh&&!!e.object.userData);return this.customRenderer?.getIntersections&&t.push(...this.customRenderer.getIntersections(this.raycaster,lf)),t}isObjectVisible(e){if(!e)return!1;if(this.frustumNeedsUpdate&&=(uf.multiplyMatrices(this.camera.projectionMatrix,this.camera.matrixWorldInverse),this.frustum.setFromProjectionMatrix(uf),!1),e.isVector3)return this.frustum.containsPoint(e);if(e.isMesh&&e.geometry){let t=e;return t.geometry.boundingBox||t.geometry.computeBoundingBox(),df.copy(t.geometry.boundingBox).applyMatrix4(t.matrixWorld),this.frustum.intersectsBox(df)}else if(e.isObject3D)return this.frustum.intersectsObject(e);else return!1}addObject(e){this.scene.add(e)}removeObject(e){this.scene.remove(e)}cleanScene(e){let t=e=>{e.map?.dispose(),e.uniforms&&Object.values(e.uniforms).forEach(e=>{e.value?.dispose?.()}),e.dispose()};e.traverse(n=>{n.geometry?.dispose(),n.material&&(Array.isArray(n.material)?n.material.forEach(e=>{t(e)}):t(n.material)),n instanceof ni||n.dispose?.(),n!==e&&this.cleanScene(n)})}},pf=class extends Li{constructor(){super(...arguments),this._abortController=new AbortController}abort(){return this._abortController.abort(),this._abortController=new AbortController,this}load(e,t,n,r){let i=this._abortController.signal,a=super.load(e,e=>{s(),t(e)},n,e=>{if(s(),i.aborted){let e=Error();e.name=`AbortError`,e.message=`The operation was aborted.`,r(e)}else r(e)});function o(){a.src=``}function s(){i.removeEventListener(`abort`,o,!1)}return i.addEventListener(`abort`,o,!1),a}},mf=class extends $d{constructor(e){super(e),this.fileLoader=new Fi,this.fileLoader.setResponseType(`blob`),this.imageLoader=new pf}destroy(){this.abortLoading(),super.destroy()}abortLoading(){this.fileLoader.abort?.(),this.imageLoader.abort()}loadFile(e,t,n){let r=Wd.get(e,n);if(r){if(r instanceof Blob)return t?.(100),Promise.resolve(r);Wd.remove(e,n)}this.config.requestHeaders&&this.fileLoader.setRequestHeader(this.config.requestHeaders(e)),this.fileLoader.setWithCredentials(this.config.withCredentials(e));let i=0;return t?.(i),this.fileLoader.loadAsync(e,e=>{if(e.lengthComputable){let n=e.loaded/e.total*100;n>i&&(i=n,t?.(i))}}).then(r=>(i=100,t?.(i),Wd.add(e,n,r),r))}loadImage(e,t,n){let r=Wd.get(e,n);return r?(t?.(100),r instanceof Blob?this.blobToImage(r):Promise.resolve(r)):!t&&!this.config.requestHeaders?(this.imageLoader.setWithCredentials(this.config.withCredentials(e)),this.imageLoader.loadAsync(e).then(t=>(Wd.add(e,n,t),t))):this.loadFile(e,t,n).then(e=>this.blobToImage(e))}blobToImage(e){return new Promise((t,n)=>{let r=document.createElement(`img`);r.onload=()=>{URL.revokeObjectURL(r.src),t(r)},r.onerror=n,r.src=URL.createObjectURL(e)})}preloadPanorama(e){return this.viewer.adapter.supportsPreload(e)?this.viewer.adapter.loadTexture(e,!1):Promise.reject(new Q(`Current adapter does not support preload`))}dispatchProgress(e){this.viewer.loader.setProgress(e),this.viewer.dispatchEvent(new _u(Math.round(e)))}},hf=class extends $d{constructor(e){super(e),this.zoom=new zl(e=>{this.viewer.state.vFov=this.viewer.dataHelper.zoomLevelToFov(e),this.viewer.state.hFov=this.viewer.dataHelper.vFovToHFov(this.viewer.state.vFov),this.viewer.dispatchEvent(new qu(e))},{defaultValue:this.viewer.config.defaultZoomLvl,min:0,max:100,wrap:!1}),this.position=new Bl(e=>{this.viewer.dataHelper.sphericalCoordsToVector3(e,this.viewer.state.direction),this.viewer.dispatchEvent(new Du(e))},{yaw:new zl(null,{defaultValue:this.config.defaultYaw,min:0,max:2*Math.PI,wrap:!0}),pitch:new zl(null,{defaultValue:this.config.defaultPitch,min:-Math.PI/2,max:Math.PI/2,wrap:!1})}),this.roll=new zl(e=>{this.viewer.state.roll=e,this.viewer.dispatchEvent(new ku(e))},{defaultValue:0,min:-Math.PI,max:Math.PI,wrap:!1}),this.updateSpeeds()}updateSpeeds(){this.zoom.setSpeed(this.config.zoomSpeed*50),this.position.setSpeed(W.degToRad(this.config.moveSpeed*50)),this.roll.setSpeed(W.degToRad(this.config.moveSpeed*50))}update(e){this.zoom.update(e),this.position.update(e),this.roll.update(e)}},gf=class{constructor(){this.ready=!1,this.needsUpdate=!1,this.continuousUpdateCount=0,this.keyboardEnabled=!1,this.direction=new K(0,0,Tc),this.roll=0,this.vFov=60,this.hFov=60,this.aspect=1,this.animation=null,this.transitionAnimation=null,this.loadingPromise=null,this.idleTime=-1,this.objectsObservers={},this.size={width:0,height:0}}},_f=class extends Gl{constructor(e){if(super(),this.plugins={},this.children=[],this.parent=Bc(e.container),!this.parent)throw new Q(`"container" element not found.`);this.parent[Ec]=this,this.container=document.createElement(`div`),this.container.classList.add(`psv-container`),this.parent.appendChild(this.container),Il(this.parent),Pl(this.container,`core`),this.state=new gf,this.config=Rd(e),this.__setSize(this.config.size),this.overlay=new qd(this);try{id.load()}catch(e){console.error(e),this.showError(this.config.lang.webglError);return}Wd.init(),this.adapter=new this.config.adapter[0](this,this.config.adapter[1]),this.renderer=new ff(this),this.textureLoader=new mf(this),this.eventsHandler=new cf(this),this.dataHelper=new nf(this),this.dynamics=new hf(this),this.adapter.init?.(),this.loader=new Gd(this),this.navbar=new Ud(this),this.panel=new Xd(this),this.notification=new Kd(this),this.autoSize(),this.setCursor(null),fl(id.isTouchEnabled,e=>{Vc(this.container,`psv--is-touch`,e)}),this.config.plugins.forEach(([e,t])=>{this.plugins[e.id]=new e(this,t)});for(let e of Object.values(this.plugins))e.init?.();this.config.navbar&&this.navbar.setButtons(this.config.navbar),this.state.loadingPromise||(this.config.panorama?this.setPanorama(this.config.panorama,{sphereCorrection:this.config.sphereCorrection,panoData:this.config.panoData}):this.loader.show())}destroy(){this.stopAll(),this.stopKeyboardControl(),this.exitFullscreen();for(let[e,t]of Object.entries(this.plugins))t.destroy(),delete this.plugins[e];this.children.slice().forEach(e=>e.destroy()),this.children.length=0,this.eventsHandler?.destroy(),this.renderer?.destroy(),this.textureLoader?.destroy(),this.dataHelper?.destroy(),this.adapter?.destroy(),this.dynamics?.destroy(),this.parent.removeChild(this.container),delete this.parent[Ec]}init(){this.eventsHandler.init(),this.renderer.init(),this.config.navbar&&this.navbar.show(),this.config.keyboard===`always`&&this.startKeyboardControl(),this.resetIdleTimer(),this.state.ready=!0,this.dispatchEvent(new ju)}resetIdleTimer(){this.state.idleTime=performance.now()}disableIdleTimer(){this.state.idleTime=-1}getPlugin(e){if(typeof e==`string`)return this.plugins[e];{let t=Pd(e);return t?this.plugins[t.id]:null}}getPosition(){return this.dataHelper.cleanPosition(this.dynamics.position.current)}getZoomLevel(){return this.dynamics.zoom.current}getSize(){return{...this.state.size}}isFullscreenEnabled(){return Qc(this.parent,id.isIphone)}needsUpdate(){this.state.needsUpdate=!0}needsContinuousUpdate(e){e?this.state.continuousUpdateCount++:this.state.continuousUpdateCount>0&&this.state.continuousUpdateCount--}autoSize(){(this.container.clientWidth!==this.state.size.width||this.container.clientHeight!==this.state.size.height)&&(this.state.size.width=Math.round(this.container.clientWidth),this.state.size.height=Math.round(this.container.clientHeight),this.state.aspect=this.state.size.width/this.state.size.height,this.state.hFov=this.dataHelper.vFovToHFov(this.state.vFov),this.dispatchEvent(new Uu(this.getSize())),this.navbar.autoSize())}setPanorama(e,t={}){this.textureLoader.abortLoading(),this.state.transitionAnimation?.cancel();let n=this.dataHelper.getTransitionOptions(t);t.showLoader===void 0&&(t.showLoader=!0),t.caption===void 0&&(t.caption=this.config.caption),t.description===void 0&&(t.description=this.config.description),!t.panoData&&typeof this.config.panoData==`function`&&(t.panoData=this.config.panoData),this.hideError(),this.resetIdleTimer(),this.config.panorama=e,this.config.caption=t.caption,this.config.description=t.description,this.config.sphereCorrection=t.sphereCorrection,(typeof this.config.panoData!=`function`||typeof t.panoData==`function`)&&(this.config.panoData=t.panoData);let r=t=>{if(hl(t))return!1;if(this.loader.hide(),this.state.loadingPromise=null,t)throw this.navbar.setCaption(null),this.showError(this.config.lang.loadError),console.error(t),this.dispatchEvent(new Cu(e,t)),t;return this.navbar.setCaption(this.config.caption),!0};this.navbar.setCaption(`<em>${this.config.lang.loading}</em>`),(t.showLoader||!this.state.ready)&&this.loader.show(),this.dispatchEvent(new yu(e));let i=this.adapter.loadTexture(this.config.panorama,!0,t.panoData).then(e=>{if(e.panorama!==this.config.panorama)throw this.adapter.disposeTexture(e),ml();let n=this.dataHelper.cleanPanoramaOptions(t,e.panoData);return(!cl(n.zoom)||!cl(n.position))&&this.stopAll(),{textureData:e,cleanOptions:n}});return!n||!this.state.ready||!this.adapter.supportsTransition(this.config.panorama)?this.state.loadingPromise=i.then(({textureData:e,cleanOptions:n})=>{this.renderer.show(),this.renderer.setTexture(e),this.renderer.setPanoramaPose(e.panoData),this.renderer.setSphereCorrection(t.sphereCorrection),this.state.ready||this.init(),this.dispatchEvent(new xu(e)),cl(n.zoom)||this.zoom(n.zoom),cl(n.position)||this.rotate(n.position)}).then(()=>r(),e=>r(e)):this.state.loadingPromise=i.then(({textureData:e,cleanOptions:t})=>(this.loader.hide(),this.dispatchEvent(new xu(e)),this.state.transitionAnimation=this.renderer.transition(e,t,n),this.state.transitionAnimation)).then(e=>{if(this.state.transitionAnimation=null,this.dispatchEvent(new Tu(e)),!e)throw ml()}).then(()=>r(),e=>r(e)),this.state.loadingPromise}setOptions(e){let t={...this.config,...e};for(let[n,r]of Object.entries(e)){if(!(n in Fd)){gl(`Unknown option ${n}`);continue}if(n in Id){gl(Id[n]);continue}switch(n in Ld&&(r=Ld[n](r,{rawConfig:t,defValue:Fd[n]})),this.config[n]=r,n){case`mousemove`:this.state.cursorOverride||this.setCursor(null);break;case`caption`:this.navbar.setCaption(this.config.caption);break;case`size`:this.resize(this.config.size);break;case`sphereCorrection`:this.renderer.setSphereCorrection(this.config.sphereCorrection);break;case`navbar`:case`lang`:this.navbar.setButtons(this.config.navbar);break;case`moveSpeed`:case`zoomSpeed`:this.dynamics.updateSpeeds();break;case`minFov`:case`maxFov`:this.dynamics.zoom.setValue(this.dataHelper.fovToZoomLevel(this.state.vFov)),this.dispatchEvent(new qu(this.getZoomLevel()));break;case`keyboard`:this.config.keyboard===`always`?this.startKeyboardControl():this.stopKeyboardControl();break;default:break}}this.needsUpdate(),this.dispatchEvent(new tu(Object.keys(e)))}setOption(e,t){this.setOptions({[e]:t})}showError(e){this.overlay.show({id:kc.ERROR,image:Qd,title:e,dismissible:!1})}hideError(){this.overlay.hide(kc.ERROR)}rotate(e){let t=new Zl(this.dataHelper.cleanPosition(e));this.dispatchEvent(t),!t.defaultPrevented&&this.dynamics.position.setValue(t.position)}zoom(e){this.dynamics.zoom.setValue(e)}zoomIn(e=1){this.dynamics.zoom.step(e)}zoomOut(e=1){this.dynamics.zoom.step(-e)}animate(e){let t=_l(e),n=!cl(e.zoom),r=new ql(t?this.dataHelper.cleanPosition(e):void 0,e.zoom);if(this.dispatchEvent(r),r.defaultPrevented)return;this.stopAll();let{duration:i,properties:a}=this.dataHelper.getAnimationProperties(e.speed,r.position,r.zoomLevel);return i?(this.state.animation=new Rl({properties:a,duration:i,easing:e.easing||`inOutSine`,onTick:e=>{t&&this.dynamics.position.setValue({yaw:e.yaw,pitch:e.pitch}),n&&this.dynamics.zoom.setValue(e.zoom)}}),this.state.animation.then(()=>{this.state.animation=null,this.resetIdleTimer()}),this.state.animation):(t&&this.rotate(r.position),n&&this.zoom(r.zoomLevel),new Rl(null))}stopAnimation(){return this.state.animation?(this.state.animation.cancel(),this.state.animation):Promise.resolve()}resize(e){this.__setSize(e),this.autoSize()}__setSize(e){[`width`,`height`].forEach(t=>{e?.[t]&&(/^[0-9.]+$/.test(e[t])&&(e[t]+=`px`),this.parent.style[t]=e[t])})}enterFullscreen(){this.isFullscreenEnabled()||$c(this.parent,id.isIphone)}exitFullscreen(){this.isFullscreenEnabled()&&el(id.isIphone)}toggleFullscreen(){this.isFullscreenEnabled()?this.exitFullscreen():this.enterFullscreen()}startKeyboardControl(){this.state.keyboardEnabled=!0}stopKeyboardControl(){this.state.keyboardEnabled=!1}createTooltip(e){return new Zd(this,e)}setCursor(e){this.state.cursorOverride=e,e?this.container.style.cursor=e:this.container.style.cursor=this.config.mousemove?`move`:`default`}observeObjects(e){this.state.objectsObservers[e]||(this.state.objectsObservers[e]=null)}unobserveObjects(e){delete this.state.objectsObservers[e]}stopAll(){return this.dispatchEvent(new Gu),this.disableIdleTimer(),this.stopAnimation()}},vf=window.PANORAMA_CONFIG||{},yf=vf.gallery??[{file:vf.panorama,title:vf.title,location:vf.location}],bf=0,xf=new _f({container:document.getElementById(`panorama-viewer`),panorama:yf[0].file,defaultYaw:vf.defaultYaw??0,defaultPitch:vf.defaultPitch??0,defaultZoomLvl:50,touchmoveTwoFingers:!1,mousewheelCtrlKey:!1,navbar:[`zoom`,`move`,`fullscreen`]});xf.addEventListener(`ready`,()=>{document.getElementById(`pano-loading`)?.classList.add(`hidden`),Cf()},{once:!0});function Sf(e){e<0||e>=yf.length||(document.getElementById(`pano-loading`)?.classList.remove(`hidden`),xf.setPanorama(yf[e].file,{transition:!0,speed:`3rpm`}).then(()=>{bf=e,document.getElementById(`pano-loading`)?.classList.add(`hidden`),document.querySelector(`.pano-header__title`).textContent=yf[e].title??``,document.querySelector(`.pano-header__subtitle`).textContent=yf[e].location??``,Cf()}))}function Cf(){let e=document.getElementById(`btn-next-pano`);e&&(e.style.display=bf>=yf.length-1?`none`:`flex`)}document.getElementById(`btn-next-pano`)?.addEventListener(`click`,()=>{Sf(bf+1)}),document.getElementById(`btn-fullscreen`)?.addEventListener(`click`,()=>{xf.toggleFullscreen()});